...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = TEMP_HUM_SENS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(TEMP_HUM_SENS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB2     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = LEFT_MOTORS_Pin|LED_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = RIGHT_MOTORS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(RIGHT_MOTORS_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = DIST_TRIGGER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(DIST_TRIGGER_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(TEMP_HUM_SENS_GPIO_Port, TEMP_HUM_SENS_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA0-WKUP     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(DIST_ECHO_GPIO_Port, DIST_ECHO_Pin);
